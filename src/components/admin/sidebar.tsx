  ...
  return (
    <aside className="hidden md:flex w-64 shrink-0 flex-col bg-navy text-mist">
      <div className="px-5 py-5 border-b border-white/10">
        <BrandLogo />
        <p className="mt-2 text-[0.7rem] uppercase tracking-wider text-mist/60">Assirik Tours · Admin</p>
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? "bg-white/10 text-sand" : "text-mist/75 hover:bg-white/5 hover:text-sand",
              )}
            >
              <Icon name={item.icon} />
              {item.label}
...
function Icon({ name }: { name: string }) {
  ...
  switch (name) {
    ...
    case "cog":
      return <svg {...common}><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 01-2.83 2.83l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09a1.65 1.65 0 00-1-1.51 1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06a1.65 1.65 0 00.33-1.82 1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09a1.65 1.65 0 001.51-1 1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06a1.65 1.65 0 001.82.33h0a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51h0a1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06a1.65 1.65 0 00-.33 1.82v0a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z"/></svg>;
    case "users":
