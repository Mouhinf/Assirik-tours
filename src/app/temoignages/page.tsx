  ...
  return (
    <>
      ...
      <PageHero
        ...
        description="Retours vérifiés de voyageurs sénégalais et de la diaspora sur nos séjours, circuits et voyages religieux."
      />
      ...
      <section className="container-narrow pb-6">
        ...
        {showLangSwitcher ? (
          <p className="mt-3 text-xs text-silver italic">
            Astuce : combinez les filtres puis changez la langue du site (FR / EN) pour
            explorer l&apos;autre collection de témoignages.
          </p>
        ) : null}
      </section>
      ...
      <section className="container-narrow pb-16">
        <header className="flex items-end justify-between gap-4 mb-6 flex-wrap">
          <p className="text-sm text-graphite">
            {total} témoignage{total > 1 ? "s" : ""} approuvé{total > 1 ? "s" : ""}.
          </p>
          {filterLocale ? (
            <span
              className={
